...
# -----------------------------------------------------------------------------
# DELPHOS VENDORED COPY
# Source : mindspore-ai/models — official/recommend/Wide_and_Deep/src/wide_and_deep.py
# Commit : eab643f51
# Reason : Pinned to avoid breaking changes from upstream updates.
#          No modifications made to this file.
# License: Apache 2.0 — https://github.com/mindspore-ai/models/blob/master/LICENSE
# -----------------------------------------------------------------------------
